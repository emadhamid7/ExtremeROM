...
# Common SEC Floating Feature configuration file for Exynos 9820
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SMARTTUTOR_PACKAGES_NAME=

SEC_FLOATING_FEATURE_AUDIO_CONFIG_MULTI_MIC=2
SEC_FLOATING_FEATURE_AUDIO_CONFIG_REMOTE_MIC=DSP;BT;USB;EAR
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_MULTIWINDOW_TRAY=TRUE
SEC_FLOATING_FEATURE_CLOCK_CONFIG_ALARM_SOUND=spotify
SEC_FLOATING_FEATURE_CAMERA_CONFIG_NIGHT_FRONT_DISPLAY_FLASH_TRANSPARENT=50

# spen
SEC_FLOATING_FEATURE_FACTORY_SUPPORT_FTL_SPEN_TYPE=
SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_SPEN_GARAGE_SPEC=
SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_SPEN_VERSION=
SEC_FLOATING_FEATURE_COMMON_CONFIG_SPEN_SENSITIVITY_ADJUSTMENT=